<?php
/**
 * ServerRebootServerIDPutRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ServerRebootServerIDPutRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServerRebootServerIDPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_server_reboot__serverID__put_request';
    ...
    {
        $this->setIfExists('type', $data ?? [], 'soft');
    }
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Server reboot type: hard or soft
     *
     * @return self
     */
