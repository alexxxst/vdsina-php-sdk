...
/**
 * SshKeyKeyIDGet200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SshKeyKeyIDGet200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_ssh_key__keyID__get_200_response_data';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name SSH key name
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status SSH key status
     *
     * @return self
     */
     ...
     * Sets data
     *
     * @param string|null $data SSH key string representation
     *
     * @return self
     */
