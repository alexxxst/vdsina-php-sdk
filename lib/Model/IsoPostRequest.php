...
/**
 * IsoPostRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class IsoPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_iso_post_request';
    ...
    */
     ...
     * Sets url
     *
     * @param string $url URL for downloading the ISO file, direct link to the application/x-iso9660-image or application/x-iso-image MIME format file, maximum file size is 10 gigabytes, protocols: http, https, ftp, ftps
     *
     * @return self
     */
