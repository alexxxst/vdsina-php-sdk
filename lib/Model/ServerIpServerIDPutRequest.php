...
/**
 * ServerIpServerIDPutRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServerIpServerIDPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_server_ip__serverID__put_request';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type IP address type
     *
     * @return self
     */
     ...
     * Sets delete
     *
     * @param int[] $delete Array of IP IDs for delete (IDs from IP pool)
     *
     * @return self
     */
