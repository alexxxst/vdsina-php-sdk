...
/**
 * ServerServerIDPutRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServerServerIDPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_server__serverID__put_request';
    ...
    public const AUTOPROLONG__0 = '0';
    public const AUTOPROLONG__1 = '1';
     ...
     * @return string[]
     */
    public function getAutoprolongAllowableValues()
    {
        return [
            self::AUTOPROLONG__0,
            self::AUTOPROLONG__1,
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('autoprolong', $data ?? [], '1');
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getAutoprolongAllowableValues();
        if (!is_null($this->container['autoprolong']) && !in_array($this->container['autoprolong'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'autoprolong', must be one of '%s'",
                $this->container['autoprolong'],
     ...
     * Sets autoprolong
     *
     * @param string|null $autoprolong Server automatic ptolongation option
     *
     * @return self
     */
    public function setAutoprolong($autoprolong)
    {
        ...
        $allowedValues = $this->getAutoprolongAllowableValues();
        if (!in_array($autoprolong, $allowedValues, true)) {
