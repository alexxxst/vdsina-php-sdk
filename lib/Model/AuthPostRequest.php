...
/**
 * AuthPostRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AuthPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_auth_post_request';
    ...
    */
     ...
     * Sets email
     *
     * @param string $email Client user login name
     *
     * @return self
     */
     ...
     * Sets password
     *
     * @param string $password Client user password
     *
     * @return self
     */
