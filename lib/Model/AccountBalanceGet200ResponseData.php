<?php
/**
 * AccountBalanceGet200ResponseData
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AccountBalanceGet200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AccountBalanceGet200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_account_balance_get_200_response_data';
    ...
    {
        $this->setIfExists('real', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['real'];
    }

    /**
     * Sets real
     *
     * @param float|null $real Real account balance
     *
     * @return self
     */
    ...
    {
        if (is_null($real)) {
            throw new \InvalidArgumentException('non-nullable real cannot be null');
        }
        $this->container['real'] = $real;
     ...
     * Sets bonus
     *
     * @param float|null $bonus Bonus balance
     *
     * @return self
     */
     ...
     * Sets partner
     *
     * @param float|null $partner Affiliate program balance
     *
     * @return self
     */
