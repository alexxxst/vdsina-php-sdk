 ...
 */
class Model403 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '403';
    ...
    public const STATUS_MSG_BLACKLISTED = 'Blacklisted';
    public const DESCRIPTION_INCORRECT_CREDENTIALS_SPECIFIED = 'Incorrect credentials specified';
    public const DESCRIPTION_THE_API_REQUESTS_LIMITS_WERE_EXCEEDED = 'The API requests limits were exceeded';
     ...
     * @return string[]
     */
    public function getStatusMsgAllowableValues()
    {
        return [
            self::STATUS_MSG_FORBIDDEN,
            self::STATUS_MSG_BLACKLISTED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_INCORRECT_CREDENTIALS_SPECIFIED,
            self::DESCRIPTION_THE_API_REQUESTS_LIMITS_WERE_EXCEEDED,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getStatusMsgAllowableValues();
        if (!is_null($this->container['status_msg']) && !in_array($this->container['status_msg'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'status_msg', must be one of '%s'",
                $this->container['status_msg'],
    ...
    public function setStatusMsg($status_msg)
    {
        ...
        $allowedValues = $this->getStatusMsgAllowableValues();
        if (!in_array($status_msg, $allowedValues, true)) {
