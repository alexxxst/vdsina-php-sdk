...
/**
 * BackupCopyBackupIDPostRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BackupCopyBackupIDPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_backup_copy__backupID__post_request';
    ...
    */
     ...
     * Sets datacenter
     *
     * @param int $datacenter Datacenter ID to copy to
     *
     * @return self
     */
