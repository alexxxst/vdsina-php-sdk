...
/**
 * BackupBackupIDGet200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BackupBackupIDGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_backup__backupID__get_200_response';
    ...
    protected static $openAPITypes = [
        'status' => 'string',
        'status_msg' => 'string',
        'data' => '\OpenAPI\Client\Model\Backup'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('status_msg', $data ?? [], 'Backup information');
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\Backup|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\Backup|null $data data
     *
     * @return self
     */
