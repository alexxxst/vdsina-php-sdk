<?php
/**
 * ServerReinstallServerIDPutRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ServerReinstallServerIDPutRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServerReinstallServerIDPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_server_reinstall__serverID__put_request';
    ...
    */
     ...
     * Sets template
     *
     * @param int|null $template OS template ID to install, the OS template may not be available for specific tariff plans
     *
     * @return self
     */
     ...
     * Sets ssh_key
     *
     * @param int|null $ssh_key SSH key ID for root user in supported OS
     *
     * @return self
     */
     ...
     * Sets host
     *
     * @param string|null $host Server hostname, must be the correct domain name
     *
     * @return self
     */
