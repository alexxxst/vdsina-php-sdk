<?php
/**
 * ServerGroupGet200ResponseDataInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ServerGroupGet200ResponseDataInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServerGroupGet200ResponseDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_server_group_get_200_response_data_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Tariff plan group ID
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Tariff plan group name
     *
     * @return self
     */
     ...
     * Sets active
     *
     * @param bool|null $active Groups status
     *
     * @return self
     */
