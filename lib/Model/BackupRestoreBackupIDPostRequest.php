<?php
/**
 * BackupRestoreBackupIDPostRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * BackupRestoreBackupIDPostRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BackupRestoreBackupIDPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_backup_restore__backupID__post_request';
    ...
    */
     ...
     * Sets service
     *
     * @param int $service Service ID to restore to (server or external disk)
     *
     * @return self
     */
