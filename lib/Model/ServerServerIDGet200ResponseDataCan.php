<?php
/**
 * ServerServerIDGet200ResponseDataCan
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ServerServerIDGet200ResponseDataCan Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServerServerIDGet200ResponseDataCan implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_server__serverID__get_200_response_data_can';
    ...
    {
        $this->setIfExists('reboot', $data ?? [], null);
        $this->setIfExists('update', $data ?? [], null);
        $this->setIfExists('delete', $data ?? [], null);
        $this->setIfExists('prolong', $data ?? [], null);
    ...
    */
     ...
     * Sets reboot
     *
     * @param bool|null $reboot Ability to reboot server
     *
     * @return self
     */
     ...
     * Sets update
     *
     * @param bool|null $update Ability to update server
     *
     * @return self
     */
     ...
     * Sets delete
     *
     * @param bool|null $delete Ability to delete server
     *
     * @return self
     */
    ...
    {
        return $this->container['prolong'];
    }

    /**
     * Sets prolong
     *
     * @param bool|null $prolong Ability to prolong server
     *
     * @return self
     */
    ...
    {
        if (is_null($prolong)) {
            throw new \InvalidArgumentException('non-nullable prolong cannot be null');
        }
        $this->container['prolong'] = $prolong;
     ...
     * Sets backup
     *
     * @param bool|null $backup Ability to create backup of server
     *
     * @return self
     */
     ...
     * Sets ip_local
     *
     * @param bool|null $ip_local Ability to create LAN for server
     *
     * @return self
     */
    ...
    {
        if (is_null($ip_local)) {
            throw new \InvalidArgumentException('non-nullable ip_local cannot be null');
        }
