<?php
/**
 * ServerServerIDGet200ResponseDataBandwidth
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ServerServerIDGet200ResponseDataBandwidth Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServerServerIDGet200ResponseDataBandwidth implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_server__serverID__get_200_response_data_bandwidth';
    ...
    {
        $this->setIfExists('current_month', $data ?? [], null);
        $this->setIfExists('last_month', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets current_month
     *
     * @param int|null $current_month Total traffic in bytes for current month
     *
     * @return self
     */
    public function setCurrentMonth($current_month)
    {
        if (is_null($current_month)) {
            throw new \InvalidArgumentException('non-nullable current_month cannot be null');
        }
     ...
     * Sets last_month
     *
     * @param int|null $last_month Total traffic in bytes for previous month
     *
     * @return self
     */
