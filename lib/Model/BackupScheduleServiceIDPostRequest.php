...
/**
 * BackupScheduleServiceIDPostRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BackupScheduleServiceIDPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_backup_schedule__serviceID__post_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['left'] > 7)) {
            $invalidProperties[] = "invalid value for 'left', must be smaller than or equal to 7.";
        }

        if (($this->container['left'] < 1)) {
        ...
        if (($this->container['hour'] > 10)) {
            $invalidProperties[] = "invalid value for 'hour', must be smaller than or equal to 10.";
        }
     ...
     * Sets left
     *
     * @param int $left How many backups stays after rotation
     *
     * @return self
     */
    public function setLeft($left)
    {
        ...
        if (($left > 7)) {
            throw new \InvalidArgumentException('invalid value for $left when calling BackupScheduleServiceIDPostRequest., must be smaller than or equal to 7.');
        }
        if (($left < 1)) {
            throw new \InvalidArgumentException('invalid value for $left when calling BackupScheduleServiceIDPostRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets hour
     *
     * @param int $hour Hour for start, night time
     *
     * @return self
     */
    public function setHour($hour)
    {
        ...
        if (($hour > 10)) {
            throw new \InvalidArgumentException('invalid value for $hour when calling BackupScheduleServiceIDPostRequest., must be smaller than or equal to 10.');
        }
        if (($hour < 0)) {
            throw new \InvalidArgumentException('invalid value for $hour when calling BackupScheduleServiceIDPostRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setDay($day)
    {
        ...
        if (($day > 31)) {
            throw new \InvalidArgumentException('invalid value for $day when calling BackupScheduleServiceIDPostRequest., must be smaller than or equal to 31.');
        }
        if (($day < 1)) {
            throw new \InvalidArgumentException('invalid value for $day when calling BackupScheduleServiceIDPostRequest., must be bigger than or equal to 1.');
        }
