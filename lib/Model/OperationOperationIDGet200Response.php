<?php
/**
 * OperationOperationIDGet200Response
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * OperationOperationIDGet200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OperationOperationIDGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_operation__operationID__get_200_response';
    ...
    protected static $openAPITypes = [
        'status' => 'string',
        'status_msg' => 'string',
        'data' => '\OpenAPI\Client\Model\Operation'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('status_msg', $data ?? [], 'Operation information');
    ...
    */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\Operation|null $data data
     *
     * @return self
     */
