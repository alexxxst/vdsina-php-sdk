...
/**
 * SshKeyKeyIDPutRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SshKeyKeyIDPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_ssh_key__keyID__put_request';
    ...
    */
     ...
     * Sets data
     *
     * @param string $data Key string represenatation
     *
     * @return self
     */
