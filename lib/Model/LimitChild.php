 ...
 */
class LimitChild implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LimitChild';
    ...
    */
     ...
     * Sets max
     *
     * @param int|null $max Maximum to order
     *
     * @return self
     */
     ...
     * Sets child_max
     *
     * @param int|null $child_max Maximum in parent service
     *
     * @return self
     */
     ...
     * Sets now
     *
     * @param int|null $now Ordered now
     *
     * @return self
     */
