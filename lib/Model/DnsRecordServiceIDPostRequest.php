...
/**
 * DnsRecordServiceIDPostRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DnsRecordServiceIDPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_dns_record__serviceID__post_request';
    ...
    */
     ...
     * Sets host
     *
     * @param string $host Name of DNS record, either with a domain postfix, or only a prefix, @ and * are also available in the name, must be the correct domain name in the end
     *
     * @return self
     */
