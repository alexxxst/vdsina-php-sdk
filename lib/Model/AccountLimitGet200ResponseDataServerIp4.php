<?php
/**
 * AccountLimitGet200ResponseDataServerIp4
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AccountLimitGet200ResponseDataServerIp4 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AccountLimitGet200ResponseDataServerIp4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_account_limit_get_200_response_data_server_ip4';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('child_max', $data ?? [], null);
    ...
    */
     ...
     * @return int|null
     */
    public function getChildMax()
    {
        return $this->container['child_max'];
    }

    /**
     * Sets child_max
     *
     * @param int|null $child_max child_max
     *
     * @return self
     */
    public function setChildMax($child_max)
    {
        if (is_null($child_max)) {
            throw new \InvalidArgumentException('non-nullable child_max cannot be null');
        }
        $this->container['child_max'] = $child_max;
