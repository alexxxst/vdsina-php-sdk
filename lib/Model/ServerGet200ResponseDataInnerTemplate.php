...
/**
 * ServerGet200ResponseDataInnerTemplate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServerGet200ResponseDataInnerTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_server_get_200_response_data_inner_template';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id OS template ID
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name OS template name
     *
     * @return self
     */
