...
/**
 * DnsRecordServiceIDGet200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DnsRecordServiceIDGet200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_dns_record__serviceID__get_200_response_data';
    ...
    protected static $openAPITypes = [
        ...
        'value' => 'string',
        'timestamp' => '\DateTime',
        'can' => '\OpenAPI\Client\Model\DnsRecordServiceIDGet200ResponseDataCan'
    ];
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id DNS record ID
     *
     * @return self
     */
     ...
     * Sets host
     *
     * @param string|null $host Name of DNS record, either with a domain postfix, or only a prefix, @ and * are also available in the name, must be the correct domain name in the end
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value Value of the DNS record, depending on the type of record, for example, for a record of type A, the value must be the correct IPv4 address
     *
     * @return self
     */
     ...
     * Sets timestamp
     *
     * @param \DateTime|null $timestamp Record timestamp
     *
     * @return self
     */
     ...
     * Gets can
     *
     * @return \OpenAPI\Client\Model\DnsRecordServiceIDGet200ResponseDataCan|null
     */
     ...
     * Sets can
     *
     * @param \OpenAPI\Client\Model\DnsRecordServiceIDGet200ResponseDataCan|null $can can
     *
     * @return self
     */
