...
/**
 * ServerGet200ResponseDataInnerServerPlan Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServerGet200ResponseDataInnerServerPlan implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_server_get_200_response_data_inner_server_plan';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Tariff plan ID
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Tariff plan name
     *
     * @return self
     */
