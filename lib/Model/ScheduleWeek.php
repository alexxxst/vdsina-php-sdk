...
/**
 * ScheduleWeek Class Doc Comment
 *
 * @category Class
 ...
 */
class ScheduleWeek implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ScheduleWeek';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['day'] > 7)) {
            $invalidProperties[] = "invalid value for 'day', must be smaller than or equal to 7.";
        }
    ...
    public function setLeft($left)
    {
        ...
        if (($left > 7)) {
            throw new \InvalidArgumentException('invalid value for $left when calling ScheduleWeek., must be smaller than or equal to 7.');
        }
        if (($left < 1)) {
            throw new \InvalidArgumentException('invalid value for $left when calling ScheduleWeek., must be bigger than or equal to 1.');
        }
     ...
     * Sets day
     *
     * @param int $day Day of week, 1 is for Monday
     *
     * @return self
     */
    public function setDay($day)
    {
        ...
        if (($day > 7)) {
            throw new \InvalidArgumentException('invalid value for $day when calling ScheduleWeek., must be smaller than or equal to 7.');
        }
        if (($day < 1)) {
            throw new \InvalidArgumentException('invalid value for $day when calling ScheduleWeek., must be bigger than or equal to 1.');
        }
    ...
    public function setHour($hour)
    {
        ...
        if (($hour > 10)) {
            throw new \InvalidArgumentException('invalid value for $hour when calling ScheduleWeek., must be smaller than or equal to 10.');
        }
        if (($hour < 0)) {
            throw new \InvalidArgumentException('invalid value for $hour when calling ScheduleWeek., must be bigger than or equal to 0.');
        }
