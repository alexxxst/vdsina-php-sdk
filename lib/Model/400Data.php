 ...
 */
class 400Data implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_400_data';
    ...
    {
        $this->setIfExists('generic', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets generic
     *
     * @param string[][]|null $generic generic
     *
     * @return self
     */
    ...
    {
        if (is_null($generic)) {
            throw new \InvalidArgumentException('non-nullable generic cannot be null');
        }
