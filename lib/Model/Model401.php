 ...
 */
class Model401 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '401';
    ...
    public const DESCRIPTION_NEED_AUTORIZATION_INFORMATION = 'Need autorization information';
    public const DESCRIPTION_INCORRECT_TOKEN = 'Incorrect token';
    ...
    {
        return [
            self::DESCRIPTION_NEED_AUTORIZATION_INFORMATION,
            self::DESCRIPTION_INCORRECT_TOKEN,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('status_msg', $data ?? [], 'Unauthorized');
