...
/**
 * IPv6pService Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class IPv6pService implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IPv6p_service';
    ...
    public const TYPE_SERVER_IP = 'server-ip';
    public const TYPE_RESERVE_IP = 'reserve-ip';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Attached service ID
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Service type
     *
     * @return self
     */
