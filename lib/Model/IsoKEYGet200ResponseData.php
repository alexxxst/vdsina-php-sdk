...
/**
 * IsoKEYGet200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class IsoKEYGet200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_iso__KEY__get_200_response_data';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('description', $data ?? [], 'Progress: 45%');
    }
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status Download job status
     *
     * @return self
     */
