...
/**
 * IsoKEYPost202ResponseData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class IsoKEYPost202ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_iso__KEY__post_202_response_data';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id ISO service ID
     *
     * @return self
     */
