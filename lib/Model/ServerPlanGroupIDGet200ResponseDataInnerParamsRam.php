...
/**
 * ServerPlanGroupIDGet200ResponseDataInnerParamsRam Class Doc Comment
 *
 * @category Class
 ...
 */
class ServerPlanGroupIDGet200ResponseDataInnerParamsRam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_server_plan__groupID__get_200_response_data_inner_params_ram';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('ram_for_cpu', $data ?? [], 1);
        $this->setIfExists('for', $data ?? [], 'Gb');
    ...
    */
     ...
     * @return int|null
     */
    public function getRamForCpu()
    {
        return $this->container['ram_for_cpu'];
    }

    /**
     * Sets ram_for_cpu
     *
     * @param int|null $ram_for_cpu RAM to CPU ratio
     *
     * @return self
     */
    public function setRamForCpu($ram_for_cpu)
    {
        if (is_null($ram_for_cpu)) {
            throw new \InvalidArgumentException('non-nullable ram_for_cpu cannot be null');
        }
        $this->container['ram_for_cpu'] = $ram_for_cpu;
     ...
     * Sets cost
     *
     * @param float|null $cost RAM cost per Gb with client discounts
     *
     * @return self
     */
     ...
     * Sets full_cost
     *
     * @param float|null $full_cost RAM full cost per Gb
     *
     * @return self
     */
