...
/**
 * ServerPasswordServerIDGet200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServerPasswordServerIDGet200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_server_password__serverID__get_200_response_data';
    ...
    */
     ...
     * Sets user
     *
     * @param string|null $user Default superuser name
     *
     * @return self
     */
     ...
     * Sets password
     *
     * @param string|null $password Default password
     *
     * @return self
     */
