...
/**
 * ServerIpServerIDGet200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServerIpServerIDGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_server_ip__serverID__get_200_response';
    ...
    protected static $openAPITypes = [
        'status' => 'string',
        'status_msg' => 'string',
        'data' => '\OpenAPI\Client\Model\IPservice[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('status_msg', $data ?? [], 'Server IP list');
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\IPservice[]|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\IPservice[]|null $data data
     *
     * @return self
     */
