...
/**
 * RegisterPost200ResponseDataUser Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RegisterPost200ResponseDataUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_register_post_200_response_data_user';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name User login
     *
     * @return self
     */
     ...
     * Sets token
     *
     * @param string|null $token API access token
     *
     * @return self
     */
