 ...
 */
class ISOFile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ISO_file';
    ...
    */
     ...
     * Sets size
     *
     * @param string|null $size File size
     *
     * @return self
     */
     ...
     * Sets md5
     *
     * @param string|null $md5 File MD5 checksum
     *
     * @return self
     */
