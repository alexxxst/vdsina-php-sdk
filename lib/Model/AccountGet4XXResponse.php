...
/**
 * AccountGet4XXResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AccountGet4XXResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_account_get_4XX_response';
    ...
    protected static $openAPITypes = [
        ...
        'status_msg' => 'string',
        'description' => 'string',
        'data' => '\OpenAPI\Client\Model\400Data'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('status_msg', $data ?? [], 'Method Not Allowed');
        $this->setIfExists('description', $data ?? [], 'Additional error description');
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\400Data|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\400Data|null $data data
     *
     * @return self
     */
