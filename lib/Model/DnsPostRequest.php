...
/**
 * DnsPostRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DnsPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_dns_post_request';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name Valid domain name
     *
     * @return self
     */
     ...
     * Sets ip
     *
     * @param string|null $ip Valid IP address for generating default DNS records
     *
     * @return self
     */
