...
/**
 * ScheduleMonth Class Doc Comment
 *
 * @category Class
 ...
 */
class ScheduleMonth implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ScheduleMonth';
    ...
    */
    ...
    public function setLeft($left)
    {
        ...
        if (($left > 7)) {
            throw new \InvalidArgumentException('invalid value for $left when calling ScheduleMonth., must be smaller than or equal to 7.');
        }
        if (($left < 1)) {
            throw new \InvalidArgumentException('invalid value for $left when calling ScheduleMonth., must be bigger than or equal to 1.');
        }
    ...
    public function setDay($day)
    {
        ...
        if (($day > 31)) {
            throw new \InvalidArgumentException('invalid value for $day when calling ScheduleMonth., must be smaller than or equal to 31.');
        }
        if (($day < 1)) {
            throw new \InvalidArgumentException('invalid value for $day when calling ScheduleMonth., must be bigger than or equal to 1.');
        }
    ...
    public function setHour($hour)
    {
        ...
        if (($hour > 10)) {
            throw new \InvalidArgumentException('invalid value for $hour when calling ScheduleMonth., must be smaller than or equal to 10.');
        }
        if (($hour < 0)) {
            throw new \InvalidArgumentException('invalid value for $hour when calling ScheduleMonth., must be bigger than or equal to 0.');
        }
