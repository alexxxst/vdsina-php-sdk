...
/**
 * ServerPasswordServerIDPutRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServerPasswordServerIDPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_server_password__serverID__put_request';
    ...
    */
     ...
     * Sets password
     *
     * @param string $password Server superuser password
     *
     * @return self
     */
